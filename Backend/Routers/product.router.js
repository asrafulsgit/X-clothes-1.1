...
const {newProduct,getAllProduct, deleteProduct, getProductByCategory, getOneProduct, getProductByCategories,updateProduct, addProduct, filterProducts, searchProduct, getProductWithPagination, newArrivals, toadaysDeals} = require('../Controllers/product.controllers');
