...
const {newProduct,getAllProduct, deleteProduct, getProductByCategory, getOneProduct, getProductByCategories,updateProduct, addProduct, filterProducts, searchProduct, getProductWithPagination, newArrivals, toadaysDeals, fixedDiscountPoducts} = require('../Controllers/product.controllers');
...
productRouter.get('/guest/todays-deals',toadaysDeals)
productRouter.get('/guest/flat-discount',fixedDiscountPoducts)
