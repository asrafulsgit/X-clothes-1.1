...
const { paymentCalculator, paymentWithCouponDiscount, createOrder, paymentSystem, payment_Success, getPaymentDetails} = require('../Controllers/Payments.controllers');
